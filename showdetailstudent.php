...
<table class="table table-bordered" align="center" style="width: 100%; height: 100vh;">
    ...
    <tr>
        <td align="center">
            ...
            <form action="adddept.php" method="post" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <table style="width: 50%; height: 100vh;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input disabled value="<?php echo "$rs1[std_name]";?>" type="text" class="form-control"  name="std_name" id="std_name" placeholder="กรุณาใส่ชื่อ"
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea disabled  class="form-control" id="std_address"name="std_address" rows="3"><?php echo "$rs1[std_address]";?></textarea>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input disabled value="<?php echo "$rs1[std_tel]";?>" type="text" class="form-control"  name="std_tel" id="std_tel" placeholder="กรุณาใส่เบอร์โทร"
                                   aria-describedby="basic-addon1">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select disabled class="custom-select" name="pa_id" id="pa_id" >
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <select disabled class="custom-select" name="c_id" id="c_id" >
                                <?php
    ...
    <input type="hidden" hidden="std_id" value="<?php echo "$rs1[std_id]"?>">
            </form>
            <!--            Inner Table-->
        </td>
    </tr>
