...
<table class="table table-bordered" align="center" style="width: 100%; height: 100vh;">
    ...
    <tr>
        <td align="center">
            ...
            <form action="editposition.php" method="post" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <table >
                    ...
                    <td colspan="2">
                        <div class="input-group mb-3">
                            ...
                            <input name="po_name" id="po_name" value="<?php echo "$rs[po_name]";?>" type="text" class="form-control"
