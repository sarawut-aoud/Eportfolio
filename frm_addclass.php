...
<table class="table table-bordered" align="center" style="width: 100%; height: 100vh;">
    ...
    <tr>
        <td align="center">
            ...
            <form action="addclassroom.php" method="post" style="margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <td colspan="2">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">Classroom Name</span>
                                </div>
                                <input name="c_name" id="c_name" type="text" class="form-control"
                                       placeholder="Classroom name" aria-label="Classroom name" aria-describedby="basic-addon1">
                            </div>
                        </td>
                    </tr>
