...
<table class="table table-bordered" align="center" style="width: 100%; height: 100vh;">
    ...
    <tr>
        <td align="center">
            ...
            <form action="editdept.php" method="post" style="margin-top: 10px; margin-bottom: 10px;">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group mb-3">
                                ...
                                <input name="d_name" id="d_name" value="<?php echo "$rs[d_name]";?>" type="text"
                                       class="form-control" placeholder="Department name" aria-label="Department name" aria-describedby="basic-addon1">
                            </div>
                        </td>
                    </tr>
