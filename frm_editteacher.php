            ...
            <form action="editteacher.php" method="post" enctype="multipart/form-data"  style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <table style="width: 50%; height: 100vh;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="<?php echo "$rs1[t_name]";?>" type="text" class="form-control"
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" id="t_address"name="t_address" rows="3"><?php echo "$rs1[t_address]";?></textarea>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="<?php echo "$rs1[t_tel]";?>" type="text" class="form-control"  name="t_tel" id="t_tel" placeholder="กรุณาใส่เบอร์โทร"
                                   aria-describedby="basic-addon1">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input value="<?php echo "$rs1[t_username]";?>" type="text" class="form-control"  name="t_username" id="t_username"
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="<?php echo "$rs1[t_password]";?>" type="password" class="form-control"  name="t_password" id="t_password"
