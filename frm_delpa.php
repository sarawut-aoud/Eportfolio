...
<table class="table table-bordered" align="center" style="width: 100%; height: 100vh;">
    ...
    <tr>
        <td align="center">
            ...
            <form action="deleteparent.php" method="post" style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <input disabled value="<?php echo "$rs[pa_name]";?>" type="text" class="form-control"  name="pa_name" id="pa_name"
                    ...
                    <tr>
                        ...
                        <td>
                            <input disabled value="<?php echo "$rs[pa_occupation]";?>" type="text" class="form-control"  name="pa_occupation" id="pa_occupation"
                    ...
                    <tr>
                        ...
                        <td>
                            <input disabled value="<?php echo "$rs[pa_tel]";?>"type="text" class="form-control"  name="pa_tel" id="pa_tel"
