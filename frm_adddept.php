                ...
                <table >
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="input-group mb-3">
                                ...
                                <input name="d_name" id="d_name" type="text" class="form-control"
                                       placeholder="Department name" aria-label="Department name" aria-describedby="basic-addon1">
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input class="btn btn-success" type="submit" value="Save" onclick="window.location='adddept.php'">
