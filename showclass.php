        ...
        <tr >
            <td align="center"  >
                ...
                <div style=" width: 80%;height:10%;text-align: right">
                    <a  class="btn btn-success" href="frm_addclass.php"  >
                ...
                <div align="center" style="width: 80%">
                    <table id="example" width="100%" style="margin-top: 10px; margin-bottom: 10px">
                        <thead align="center">
                        <tr>
                            <th width="15%">รหัสชั้นเรียน</th>
                            <th width="15%">ชื่อชั้นเรียน</th>
                            <th width="20%"></th>
                            <th width="15%"></th>
                            <!--<th width="25%"></th>-->
                        </tr>
                        ...
                        while ($rs = mysql_fetch_object($result)) {
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="frm_addclassdetail.php?c_id=<?php echo $rs->c_id;?>">
                                        จัดการหัวหน้าชั้นเรียน
                                    </a>

                                </td>
                                <td align="center">
                                    <a class="btn btn-warning"  href="frm_editclass.php?c_id=<?php echo $rs->c_id;?>">
                                        <i class="fas fa-pen"></i> Edit
                                    </a>
                                    <a class="btn btn-danger" onclick="deleteLocation(<?php echo $rs -> c_id ;?>)" style="color: white">
        ...
        function deleteLocation(c_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "deleteclassroom.php?c_id="+c_id;
                }
            })
        };
    </script>
